...
for line in f:
	...
	if session_created_by not in person.values():
		person[(session_created_by)] = {"name": "session_creator-%s" % session_id, "type" : "session creator"}
f.close()
...
# now that our nodes are complete, write them to a file
...
# lets identify anyone who voted for someone else at least 5 times
